...
```clj
{:deps {com.bhauman/certifiable {:mvn/version "0.0.3"}}}
```
...
```sh
$ clj -Sdeps '{:deps {com.bhauman/certifiable {:mvn/version "0.0.3"}}}' -m certifiable.main
```
...
```sh
$ clj -Sdeps '{:deps {com.bhauman/certifiable {:mvn/version "0.0.3"}}}' -m certifiable.main -d "example.test,localhost"
```
...
```sh
$ clj -Sdeps '{:deps {com.bhauman/certifiable {:mvn/version "0.0.3"}}}' -m certifiable.main -d "example.test,localhost" -o "dev-example.jks"
```
...
```sh
$ clj -Sdeps '{:deps {com.bhauman/certifiable {:mvn/version "0.0.3"}}}' -m certifiable.main --reset
```
